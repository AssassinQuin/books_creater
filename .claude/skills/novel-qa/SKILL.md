...
Step 4: Smell Test（借鉴humanize）
  - 问模型："如果我在网文平台看到这一章，我会觉得是人写的，还是AI写的？"
  - 如果回答"像AI"→ 标记为P1，要求重写关键段落
  - 检查点：
    - 是否有"他知道/她明白"等旁白式心理总结？
    - 高压场景角色是否像特种兵一样永远从容？
    - 连续段落长度是否像复制粘贴？
    - 是否有"值得一提的是/不禁/缓缓"等AI过渡词？
Step 5: 问题分级 P0/P1/P2/P3
  - P0: 三视角冲突（人物逻辑 vs 作者结构）/因果链断裂/人物OOC
  - P1: 单视角严重问题/伏笔未回收/节奏断层/Smell Test失败
  - P2: 单视角中等问题/描写冗余/对话平淡
  - P3: 轻微问题/标点不均/用词重复
Step 6: 输出审阅报告 → 评级 A(≥90)/B(≥80)/C(≥70)/D(<70)
  - 报告必须包含三视角审查结果 + Smell Test结论
