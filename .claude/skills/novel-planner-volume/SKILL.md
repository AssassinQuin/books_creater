...
{叙事性描述：用故事化语言写出本章核心事件、角色互动、情感走向。1-3段。}

**叙事动作**: {节奏/视角/信息投放的具体叙事指令}
...
**因果链**: 因为{前因} → 所以{后果} → 逼出{选择}

**叙事动作**: {...}

## 核心信息投放节奏

| 信息块 | 投放章节 | 投放方式 | 读者认知变化 |
|--------|---------|---------|------------|
| {信息1} | Ch{?} | {通过什么场景/对话投放} | {读者从不知道→知道/从误解→理解} |
| {信息2} | Ch{?} | {...} | {...} |
...
**模板使用规则**：
- 简单章节用基础模板（叙事描述 + 叙事动作）
- 复杂章节（高潮/转折/冲突）用扩展模板（+事件要点/对话/因果链）
- 情绪弧线表按节奏段分组（如 Ch1-Ch4 为一段），不强制每章一行
- 信息投放表和伏笔清单从 Step 1-2 输出直接填充
