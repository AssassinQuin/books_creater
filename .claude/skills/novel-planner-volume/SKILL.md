...
大纲风格：**叙事性描述为主**，不用表格堆砌。叙事动作注释用 `**叙事动作**:` 标记。

#### 卷级大纲模板

> 把握卷级故事脉络：主线怎么走、支线怎么推、人物怎么变。**不做逐章规划**，留给正文写作阶段。
...
{叙事性描述，3-5段，用故事化语言写出本卷主线从起点到终点的完整弧线。
覆盖起承转合但不硬拆四段——按故事的天然节奏来写。}

### 起

{故事开篇建立：场景、角色状态、初始冲突。叙事性描述，1-2段。}

### 承

{事件推进：冲突升级、角色互动、势力博弈。叙事性描述，2-3段。}

### 转

{转折/高潮：核心事件爆发、真相揭露、关系断裂或重建。叙事性描述，1-2段。}

### 合

{收尾+下卷钩子：新平衡建立、遗留悬念、角色新状态。叙事性描述，1段。}
...
**模板使用规则**：
- 起承转合是故事节奏的自然段落，不是硬切——按实际故事节奏灵活分段
- 支线数量不限，但每条必须有"卷内弧线"（哪怕只是"推进了一步"）
- 人物弧光表只写**有变化的**角色，不变的注明理由
- 伏笔只记本卷新埋的，回收的在上卷伏笔清单标记
